...
int main(int argc, char *argv[]) {
    ...
    semantic_segmentation::GlobalSemanticConsistency<ImageType> 						gdc;
	semantic_segmentation::GlobalSemanticConsistency<ImageType>::MatchingStruct 		m = gdc.evaluate(img,gt);
